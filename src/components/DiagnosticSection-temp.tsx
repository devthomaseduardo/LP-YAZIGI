          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl mb-8 text-white/90 font-light max-w-3xl mx-auto leading-relaxed'>
              ...
              <span className='relative inline-block'>
                <span className='absolute -inset-1 bg-accent/20 rounded-lg blur'></span>
            ...
            <div className='relative inline-block group'>
              <div className='absolute -inset-1 bg-accent/70 rounded-full blur-md opacity-70 group-hover:opacity-100 transition-opacity'></div>
              <Button
                size='lg'
